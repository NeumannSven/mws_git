...
public:
    /**
     ********************************************************************************
     * @brief      Constructor is deprecated - avoid using this constructor,
     *             does not work with include_perm files.
     *             Constructs a ModuleConfiguration object
     *
     ...
     *******************************************************************************/
    DEPRECATED(explicit ModuleConfiguration(std::string moduleName));
     ...
     * @param[in]  lineNumber       The line number, from where to read the configuration
