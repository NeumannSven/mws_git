...
public:
     ...
     *******************************************************************************/
    virtual SmiClient* createClient(std::string ip, std::string username, std::string password);
     ...
     * @param[in]  username           Username for login to remote controller
     * @param[in]  password           Password for login to remote controller
     * @param[in]  toolName           Toolname to be logged at login on remote controller
     *******************************************************************************/
    virtual SmiClient* createClient(std::string ip, std::string username, std::string password, std::string toolName);
     ...
     *******************************************************************************/
    virtual SmiClient* createClient();
