...
public:
     ...
     *
     */
    BasicAnalogModule(UINT32 ui32CardNumber);

    /**
     * Constructor
     *
     * @param ui32CardNumber - configured Cardnumber
     * @param pSystem - MIOSystem to handle communication with card
     *
     */
    BasicAnalogModule(UINT32 ui32CardNumber, MIOSystem *pSystem);
