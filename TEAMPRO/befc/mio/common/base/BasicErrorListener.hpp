...
/**
 * @brief Abstract Interface class for Error-Listener
 */
...
public:
    ...
    /**
     * @brief Gets the MIO system actual for this listener
     *
     * When ErrorOccured is called, a call to the MIO system is needed for getting module information
     *
     */
    virtual MIOSystem* getMIOSystem() = 0;
