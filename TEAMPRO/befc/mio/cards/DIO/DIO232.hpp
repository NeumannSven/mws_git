...
public:
     ...
     * Constructor
     *
     * @param ui32CardNumber - configured card number
     *
     * @throws a MIOexception when card does not match class
     */
     ...
     *
     * @param ui32CardNumber - configured card number
     * @param pMioSystem - specific MIO system for this digital module
     *
     * @throws a MIOexception when card does not match class
     */
    explicit DIO232(UINT32 ui32CardNumber, MIOSystem *pMioSystem);
