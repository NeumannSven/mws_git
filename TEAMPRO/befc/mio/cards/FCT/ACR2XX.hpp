...
protected:
     ...
     * There are 6 entries (e) and an 8 Bit Counter (c)
     * each entry contains 4 Status Bits
     *
     * 32                                       0
     *   cccc cccc eeee eeee eeee eeee eeee eeee
     *
     * @param[out] psState   Pointer to an allocated SState_t,
     * if NULL then function returns without doing any work
     * @param[in] ui32Value 32 bit value that contains 6 state
     * entries in the lower 24 bits
     * @param[in] ui8Index  Index to the entry to be extracted,
     * valid values are 0,4,8,12,16,20
     */
     ...
     *   cccc cccc eeee eeee eeee eeee eeee eeee
     *
     *  @param[out] pui8Counter Pointer to a preallocated byte of data
     *  that is filled with the highest 8 bits of the ui32Value
     *  @param[in] ui32Value    32 bit value that is shifted 24 bits to the
     *  right and then masked for the lowest 8 bits
     *
     */
