...
public:
     ...
     * @param[in] freqLimit - Pointer to the frequency limit structure
     * @param[in] Mask1 - Specify the ID of the limit to be written (GMP232X_LIM_F_*)
     * @param[in] Mask2 - Specify the ID of the limit to be written (GMP232X_LIM_F_*)
     *
     * @throws a MIOexception when writing to card fails,
     * or if the pointer to card is invalid
     */
    VOID setFrequencyLimit(GMP232X_LIMIT_FREQ *freqLimit, UINT32 Mask1, UINT32 Mask2);

    /**
     * Reads frequency limit
     * @param[in] Mask1 - Specify the ID of the limit to be read (GMP232X_LIM_F_*)
     * @param[in] Mask2 - Specify the ID of the limit to be read (GMP232X_LIM_F_*)
     * @returns a pointer to the frequency limit structure
     *
     * @throws a MIOexception when writing to card fails,
     * or a MIOexception if pointer to card is invalid
     */
    const GMP232X_LIMIT_FREQ* getFrequencyLimit(UINT32 Mask1, UINT32 Mask2);

    /**
     * Writes voltage fault ride through limit
     * @param[in] VfrtLimit - Pointer to the input data structure
     ...
     * @param[in] FfrtLimit - Pointer to the input data structure
     ...
     * @param[in] VoltageLimit - Pointer to the input data structure
     * @param[in] limitId - Specify the ID of the limit to be written (GMP232X_LIM_1_V_*)
     *
     * @throws a MIOexception when writing to card fails,
     * or if the pointer to card is invalid
     */
    ...
    /**
     * Reads voltage limit
     * @param[in] limitId - Specify the ID of the limit to be read (GMP232X_LIM_1_V_*)
     * @returns a pointer to the voltage limit structure
     *
     * @throws a MIOexception when writing to card fails,
     * or a MIOexception if pointer to card is invalid
     */
    const GMP232X_LIMIT_V* getVoltageLimit(UINT32 limitId);

    /**
     * Writes QU limit
     * @param[in] QULimit - Pointer to the input data structure
     ...
     * @param[in] VectorJumpLimit - Pointer to the input data structure
     * @param[in] limitId - Specify the ID of the limit to be written (GMP232X_LIM_2_VECTORJUMP1 or GMP232X_LIM_2_VECTORJUMP2*)
     *
     * @throws a MIOexception when writing to card fails,
     * or if the pointer to card is invalid
     */
     ...
     * @param[in] limitId - Specify the ID of the limit to be read (GMP232X_LIM_2_VECTORJUMP1 or GMP232X_LIM_2_VECTORJUMP2*)
     * @returns a pointer to the Vector Jump limit structure
     *
     * @throws a MIOexception when writing to card fails,
     * or a MIOexception if pointer to card is invalid
     */
    const GMP232X_LIMIT_VECTORJUMP* getVectorJumpLimit(UINT32 limitId);

    /**
     * Writes Harmonic limit
     * @param[in] HarmonicLimit - Pointer to the input data structure
     ...
     * @param[in] CurrentLimit - Pointer to the input data structure
     ...
     * @param[in] ThdTddLimit - Pointer to the input data structure
     * @param[in] limitId - Specify the ID of the limit to be written (GMP232X_LIM_I_*)
     *
     * @throws a MIOexception when writing to card fails,
     * or a MIOexception if pointer to card is invalid
     ...
     * @param[in] AsymmetryLimit - Pointer to the input data structure
    ...
    /**
     * Writes rocof limit
     * @param[in] RocofLimit - Pointer to the input data structure
     *
     * @throws a MIOexception when writing to card fails,
     * or a MIOexception if pointer to card is invalid
     */
     ...
     * or a MIOexception if pointer to card is invalid
     */
    const GMP232X_LIMIT_ROCOF* getRocofLimit(VOID);

    /**
     * Writes max power limit
     * @param[in] MaxPowerLimit - Pointer to the input data structure
     ...
     * @param[in] ReversePowerLimit - Pointer to the input data structure
     ...
     * @param[in] CurrentDirectionLimit - Pointer to the input data structure
     ...
     * @param[in] selector - Select rated or fundamental
     *
     ...
     * or a MIOexception if pointer to card is invalid
     */
    GMP232X_BULK_THD_TDD* getBulkTHD_TDD_Values(UINT32 selector);
     ...
     * @param[in] frmsHcs - pointer to the FRMS HCS data structure
     *
     * @throws a MIOexception when writing to card fails,
     * or a MIOexception if pointer to card is invalid
     */
     ...
     * @param[in] trmsHcs - pointer to the TRMS HCS data structure
     *
     * @throws a MIOexception when writing to card fails,
     * or a MIOexception if pointer to card is invalid
     */
     ...
     * or a MIOexception if pointer to card is invalid
     */
    GMP232X_CONFIG_EXT_2* getExtendenCfg(VOID);
     ...
     * or a MIOexception if pointer to card is invalid
     */
    VOID setExtendenCfg(GMP232X_CONFIG_EXT_2 *ExtendedCfg);
     ...
     * @param[out] dataPoints[]      Where to return the data points read
	 *
	 * @throws a MIOexception when writing to card fails,
	 * or a MIOexception if pointer to card is invalid
	 */
     ...
     * @param[in]  StatisticId      Statistic identifier
     ...
     * @note Updated dependent on statistic value; uses update rate of corresponding value
     * @param[in]  Id_RangeStart	Begin of range (inclusive); #GMP232X_IDX_U_L1N_INST or similar
     * @param[in]  NbrOfValues		Number of data points to read, use 1 for a single data point
     * @param[out] dataPoints[]		Where to return the data point read
	 *
	 * @throws a MIOexception when writing to card fails,
	 * or a MIOexception if pointer to card is invalid
	 */
     ...
     * @param[in]  NbrOfValues        Number of data points in dataPointId[], use 1 for a single data point
     * @param[out] dataPoints[]        Where to return the data points read, array of size DataPointLength
	 *
	 * @throws a MIOexception when writing to card fails,
	 * or a MIOexception if pointer to card is invalid
	 */
...
private:
    ...
    GMP232X_CONFIG_EXT_2 m_ExtendedCfg;
