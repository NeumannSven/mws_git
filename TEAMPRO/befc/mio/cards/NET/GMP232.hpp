...
public:
     ...
     * Constructor
     *
     * @param ui32CardNumber - Card number of Module
     *
     * @throws a MIOexception when card does not match class
     */
     ...
     * Read Harmonics
     *
     * @param[in] id - see EHarmonicsId_t
     ...
     *
     * @param psValue - pointer to SScopeConfig_t
     *
     * @throws a MIOexception when writing to card fails,
     * or a MIOexception if pointer to card is invalid
     */
     ...
     *
     * @param eLimit - see ELimitType_t
     * @param eId - see ELimitId_t
     ...
     *
     * @param psValue - see SFrequencyLimit_t
     * @param eId - see EFrequencyLimit_t
     *
     * @throws a MIOexception when writing to card fails,
     * or a MIOexception if pointer to card is invalid
     */
     ...
     *
     * @param[in] eId - see EFrequencyLimit_t
