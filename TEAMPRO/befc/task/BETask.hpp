...
public:
     ...
     *
     * @param[in]  descriptors      A list of SviExportDescriptors
     *******************************************************************************/
...
private:
    ...
    /**
     ********************************************************************************
     * @brief      Helper function for calculate time monotonic.
     *             N.B. tick count will loop around but not in my life time!
     *
     * @retval     tick since reboot
     *******************************************************************************/
    UINT64 getTickMonotonic(void);
