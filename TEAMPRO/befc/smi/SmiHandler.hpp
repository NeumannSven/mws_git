...
public:
    ...
    const static UINT32 DEFAULT_REQUEST_MODULENB_RETRY = 10;    //Defined in seconds
   ...
   /**
     ...
     *******************************************************************************/
    explicit SmiHandler(BETaskConfiguration conf, UINT32 protocolType);
    ...
    /**
     ********************************************************************************
     * @brief      Remove listener. Removed by pointer reference.
     *
     * @param[in]  pListener           The listener which should be removed
     *******************************************************************************/
    void removeErrorListener(SmiHandlerErrorListener *pListener);
