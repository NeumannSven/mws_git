...
public:
     ...
     * @param[in,out] pValueLst Pointer to an array of 32-bit variables, for returning
     *                          the read values
     *                          Read values of the desired process variables
     ...
     * @param[in]  pLib       Pointer to function library (returned by svi_GetLib())
     * @param[in]  Addr       SVI address of the desired process value (returned by svi_GetAddr())
     * @param[in,out]  pBuff  Pointer to the read buffer
     *                        Read data block
     * @param[in,out] pBuffLen Length of the read buffer
     *                         Length of the read data block
     ...
     * @param[in,out] pFormat If the pointer points to the special code #SVI_F_EXTLEN,
     *                        also the data length of the variable is returned
     *                        SVI data format @ref SVI_F_ and direction (#SVI_F_IN, #SVI_F_OUT).
     ...
     * @param[in,out] pNbOfPv Number of desired process variables
     *                        Number of read process variables information
     * @param[in,out] pPvInf  Pointer to process variables information buffer
     *                        Buffer with the process variables information
     *
     ...
     *
     * @param[in]     pLib     Pointer to function library (returned by svi_GetLib())
     * @param[in,out] pServInf Pointer to buffer
     *                         Information about the SVI server
     *
     * @retval SVI_E_OK       Information buffer successfully filled
     * @retval SVI_E_PARM     Invalid function library pointer
     * @retval SVI_E_OLDADDR  The function library of the module has turned to invalid state
     ...
     * @param[in]  pLib       Pointer to function library (returned by svi_GetLib())
     * @param[in]  Addr       SVI address of the desired process value (returned by svi_GetAddr())
     * @param[in,out] pVarInf Pointer to buffer
     *                        Information about the SVI variable
     *
     * @retval SVI_E_OK       Information buffer successfully filled
     * @retval SVI_E_PARM     Invalid function library pointer
     * @retval SVI_E_OLDADDR  The function library of the module has turned to invalid state
     ...
     *                       svi_AddVirtVar())
     * @param[out]  pBuff     Pointer to the read buffer
