...
public:
     ...
     * @brief      Constructor
     *
     * @param[in]  name         Name of the group - for debugging and identifying
     * @param[in]  pTask        The BETask which handles the updating of the group
     * @param[in]  ip           The IP of the remote controller for getting SVI Items
     * @param[in]  username     The username for the remote login
     * @param[in]  password     The password for the remote login
     *******************************************************************************/
     ...
     * @param[in]  pTask        The BETask which handles the updating of the group
     * @param[in]  ip           The IP of the remote controller for getting SVI Items
     * @param[in]  pClient      The SmiClient for handling the connection to the controller
     *******************************************************************************/
    RemoteSviGroup(std::string name, BETask* pTask, std::string ip, SmiClient *pClient);
