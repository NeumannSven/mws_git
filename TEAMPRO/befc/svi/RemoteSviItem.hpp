...
public:
     ...
     * @param[in]  lib              Pointer to the library
...
private:
     ...
     * @param[in]  ignoreIfDirty    Ignore setting value internal, if item is dirty
     * @param[in]  setDirtyFlag     Whether or not to set the AbstractSviItem dirty
     *******************************************************************************/
    VOID setValueInternal(SviValue *pValue, bool ignoreIfDirty, bool setDirtyFlag);
};
