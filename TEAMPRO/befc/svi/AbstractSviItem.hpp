...
public:
     ...
     * @param[in]  lib              Library pointer for local SVI items
    ...
    /**
     ********************************************************************************
     * @brief      Gets the current data quality of the item
     *
     * @retval     A @see SviItemEventListener::DataQuality object containing state.
     *******************************************************************************/
    const SviItemEventListener::DataQuality getQualityState();
