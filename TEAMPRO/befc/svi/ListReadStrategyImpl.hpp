...
public:
    ...
    /**
     ********************************************************************************
     * Definition of how many items allowed in each call
     *******************************************************************************/
    static const int MAXITEMSINCALL = 64;

    /**
     ********************************************************************************
     * @brief      Constructor for ListReadStrategyImpl. This strategy makes use of the svi function
     *             getValues, which can get up to @see MAXITEMSINCALL values in one call. These values
     *             can only be of maxlength 32 bit.
     *
     * @param[in]  pSystem       The SviSystem to use.
     *******************************************************************************/
...
private:
    ...
    /**
     ********************************************************************************
     * @brief      Helper function to reset dirty flag on the items in the array.
     *
     * @param[in]  vals         The reference to the fixed length array
     * @param[in]  size         The number of items which should be reset.
     *******************************************************************************/
    void resetDirtyFlag(AbstractSviItem*(&vals)[MAXITEMSINCALL], int size);
